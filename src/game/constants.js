...
export const TILE_COLORS = {
  ...
  [TILE_TYPES.SUPPORT_PILLAR]: ['#CD853F', '#DEB887', '#B8860B'],
  [TILE_TYPES.PRESSURE_PLATE]: ['#4169E1', '#6495ED', '#1E90FF'],
  [TILE_TYPES.FRAGILE_WALL]: ['#A0522D', '#8B6914', '#996633'],
  [TILE_TYPES.DOOR]: ['#8B8682', '#A9A9A9', '#696969']
};
...
export const TILE_HARDNESS = {
  ...
  [TILE_TYPES.SUPPORT_PILLAR]: 2,
  [TILE_TYPES.PRESSURE_PLATE]: 0,
  [TILE_TYPES.FRAGILE_WALL]: 1,
  [TILE_TYPES.DOOR]: 999
};
